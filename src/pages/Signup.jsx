          ...
          <div className="p-8">
            ...
            {emailSent && (
              <div className="mb-4 p-4 rounded bg-blue-100 border border-blue-300 text-blue-800 text-sm">
                ...
                <div className="mb-2">Please check your email and click the verification link to activate your account.</div>
                <div className="text-xs text-blue-700">Redirecting to login page...</div>
              </div>
            )}
